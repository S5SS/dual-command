...
supplyLimit("Probe_hw2", 12);
supplyLimit("ProximitySensor_hw2", 12);
...
-- Vaygr
supplyLimit("Fighter", 270);
supplyLimit("Scout", 60);
supplyLimit("Interceptor", 270);
supplyLimit("Bomber", 270);
supplyLimit("LanceFighter", 270);
supplyLimit("Corvette", 150);
supplyLimit("Capital", 46);
supplyLimit("Carrier", 10);
