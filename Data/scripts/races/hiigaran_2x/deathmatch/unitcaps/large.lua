...
--
supplyLimit("Capital", 42);
	
supplyLimit("Destroyer", 18);
supplyLimit("MissileDestroyer", 8);
...
supplyLimit("Probe_hw2", 8);
supplyLimit("ProximitySensor_hw2", 8);
