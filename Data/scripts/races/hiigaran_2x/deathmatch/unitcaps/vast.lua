supplyLimit("Fighter", 500);

supplyLimit("Scout", 120);
supplyLimit("Interceptor", 500);
supplyLimit("Bomber", 500);
supplyLimit("LanceFighter", 500);
...
--
supplyLimit("Capital", 108);

supplyLimit("Destroyer", 44);
...
supplyLimit("Probe_hw2", 24);
supplyLimit("ProximitySensor_hw2", 24);
